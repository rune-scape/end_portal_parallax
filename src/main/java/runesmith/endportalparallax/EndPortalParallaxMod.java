...
//        ClientRegistry.registerKeyBinding(RELOAD_SHADERS_KEYBINDING);
    ...
    public void onCameraSetup(EntityViewRenderEvent.CameraSetup event) {
        ...
        Renderer.updateCameraPos(event.getInfo().getPosition());
    }
...
//            while (RELOAD_SHADERS_KEYBINDING.consumeClick()) {
//                RenderSystem.recordRenderCall(Renderer::reloadEndPortalParallaxShader);
//                Minecraft.getInstance().gui.getChat().addMessage(new StringTextComponent("End portal shaders reloaded"));
//            }
//        }
//    }
}
