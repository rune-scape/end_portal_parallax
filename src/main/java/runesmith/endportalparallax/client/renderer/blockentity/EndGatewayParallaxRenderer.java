...
public class EndGatewayParallaxRenderer extends TheEndGatewayRenderer {
    ...
    @Override
    public void render(@NotNull TheEndGatewayBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLightIn, int combinedOverlayIn) {
