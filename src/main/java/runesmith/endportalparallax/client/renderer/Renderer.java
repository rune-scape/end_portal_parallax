...
//    }
    ...
    public static void renderPortal(TileEntity tileEntity, double x, double y, double z, double offsetUp, double offsetDown) {
        ...
        ShaderInstance shaderInstance = getEndPortalParallaxShader();
        ...
        renderPortalFace(tileEntity, buffer, maxX, minX, maxZ, maxZ, maxY, maxY, minY, minY, Direction.SOUTH);
        renderPortalFace(tileEntity, buffer, minX, maxX, minZ, minZ, maxY, maxY, minY, minY, Direction.NORTH);
        renderPortalFace(tileEntity, buffer, maxX, maxX, minZ, maxZ, minY, maxY, maxY, minY, Direction.EAST);
        renderPortalFace(tileEntity, buffer, minX, minX, maxZ, minZ, minY, maxY, maxY, minY, Direction.WEST);
        renderPortalFace(tileEntity, buffer, minX, maxX, minZ, maxZ, minY, minY, minY, minY, Direction.DOWN);
        renderPortalFace(tileEntity, buffer, minX, maxX, maxZ, minZ, maxY, maxY, maxY, maxY, Direction.UP);
    ...
    private static void renderPortalFace(TileEntity tileEntity, BufferBuilder buffer, double x1, double x2, double z1, double z2, double y1, double y2, double y3, double y4, Direction dir) {
